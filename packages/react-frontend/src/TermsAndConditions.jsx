        ...
        <div className="terms-text-container">
          ...
          <div className="terms-divider">
            ...
            <p className="terms-divider-text">
              ...
              any way that could damage, disable, or impair the service. You are
              responsible for all content you post.
            </p>
          </div>
          ...
          <div className="terms-divider">
            ...
            <p className="terms-divider-text">
              When listing items, you must provide accurate descriptions and
              images. You are responsible for the accuracy of all information
              provided in your listings.
            </p>
          </div>

          <div className="terms-divider">
            <h2 className="terms-divider-title">
              5. Meeting Up With Other Users
            </h2>
            <p className="terms-divider-text">
              SLOFits is not responsible for any interactions between users. It
              is up to the users to decide how to meet up with each other.
              SLOFits recommends meeting up in a public place and to always be
              cautious.
            </p>
          </div>
